...
const SUPPORT_CARDS = {
  ...
  Red: {
    ...
    rarity: 'Legendary',
    supportType: 'Attack',
    baseStats: { HP: 0, Attack: 70, Defense: 0, Instinct: 10, Speed: 15 },
  ...
  Mustard: {
    ...
    rarity: 'Legendary',
    supportType: 'Attack',
    baseStats: { HP: 0, Attack: 65, Defense: 10, Instinct: 5, Speed: 12 },
    trainingBonus: { typeMatch: 11, otherStats: 1, maxFriendshipTypeMatch: 29 },
    initialFriendship: 5,
    appearanceRate: 0.30,
  ...
  Koga: {
    ...
    rarity: 'Uncommon',
    supportType: 'Speed',
    baseStats: { HP: 0, Attack: 5, Defense: 10, Instinct: 5, Speed: 23 },
    trainingBonus: { typeMatch: 7, otherStats: 2, maxFriendshipTypeMatch: 18 },
    initialFriendship: 10,
    appearanceRate: 0.35,
    typeMatchPreference: 0.35,
  ...
  Chuck: {
    ...
    rarity: 'Common',
    supportType: 'Attack',
    baseStats: { HP: 0, Attack: 26, Defense: 0, Instinct: 0, Speed: 5 },
    trainingBonus: { typeMatch: 7, otherStats: 1, maxFriendshipTypeMatch: 15 },
    initialFriendship: 5,
    appearanceRate: 0.35,
    typeMatchPreference: 0.30,
    specialEffect: null,
